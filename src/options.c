...
/* host */
DEFINE_PERSISTENT_OPTION_INT(bios,                    0,                 "Boot to bios");
DEFINE_PERSISTENT_OPTION_STRING(sync,      "audio and video", "Time sync");
DEFINE_PERSISTENT_OPTION_INT(fullscreen,   1,                 "Start window fullscreen");
DEFINE_PERSISTENT_OPTION_INT(key_a,        'v',               "A button mapping");
DEFINE_PERSISTENT_OPTION_INT(key_b,        'c',               "B button mapping");
...
DEFINE_PERSISTENT_OPTION_INT(key_ltrig,    '1',               "Left trigger mapping");
DEFINE_PERSISTENT_OPTION_INT(key_rtrig,    '2',               "Right trigger mapping");
...
DEFINE_PERSISTENT_OPTION_STRING(bootbios, "false",            "Boot to the Dreamcast BIOS");
